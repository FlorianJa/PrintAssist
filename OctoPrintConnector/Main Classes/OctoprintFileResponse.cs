...
namespace OctoPrintConnector.File
{
    public class OctoprintFileResponse
    {
        public List<OctoprintFile> files { get; set; }
        ...
        //public OctoprintFolder(JObject data, OctoprintFileOperation t)
        //{
